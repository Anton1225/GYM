        ...
        onViewportEnter={() => setSelectedPage(SelectedPage.Home)}> 
            ...
            <div className="z-10 mt-32 md:basis-3/5">
                ...
                <motion.div className="md:-mt-20" initial='hidden' whileInView='visible' viewport={{once: true, amount: 0.5}} transition={{duration: 0.5}} variants={{hidden: {opacity: 0, x: -50}, visible: {opacity: 1, x: 0}}}>
                    ...
                    <p className='mt-8 text-sm md:text-start'>Unrivale Gym. Unparalleled Training Fitness Classes. World Class Studios to get the Body Shapes That you Dream of.. Get Your Dream Body Now</p>
                </motion.div>
                {/*ACTION BUTTONS*/}
                ...
                <AnchorLink onClick={() => setSelectedPage(SelectedPage.ContactUs)} href={`#${SelectedPage.ContactUs}`} className="text-sm font-bold text-primary-500 underline hover:text-secondary-500">
                    <p className="mt-8 text-sm md:text-start">Learn More</p>
                </AnchorLink>
                </motion.div>
            </div>
            {/*IMAGE*/}
