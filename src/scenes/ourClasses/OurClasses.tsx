            ...
            variants={{
              ...
              visible: {opacity: 1, x: 0}
                ...
                <div className='md:w-3/5'>
                    ...
                    <p className='py-5'>Fringilla a sed at suspendisse ut enim volutpat. Rhoncus
                     vel est tellus quam porttiour.Marius velit eusimmodo semper viverra nam libero 
                     justo laoreet sit amet.</p>
                </div>
